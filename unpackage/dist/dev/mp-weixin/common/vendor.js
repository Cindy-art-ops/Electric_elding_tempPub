...
function initRuntimeSocketService() {
  const hosts = "198.18.0.1,10.25.252.252,127.0.0.1,172.18.16.1";
  const port = "8090";
  const id = "mp-weixin_siBxoZ";
...
const pages = [
  ...
  {
    path: "pages/learn/material",
    style: {
      navigationBarTitleText: "学习资料"
    }
  },
  {
    path: "pages/quiz/chapter",
    style: {
      navigationBarTitleText: "章节自测"
    }
  },
  {
    path: "pages/quiz/import",
    style: {
      navigationBarTitleText: "题库导入"
    }
  },
  {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","198.18.0.1","10.25.252.252","172.18.16.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","G:/HBuilderX.4.75/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"tiaozhan-hanjie","spaceId":"mp-77e9f516-a0e0-4dde-8ef1-a6fea4c2e46c","clientSecret":"s1UHw7H9L8RJrAaeSpKq7g==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__0160B1B";
} catch (e2) {
